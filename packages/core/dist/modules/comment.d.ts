...
export declare function getCommentBoxPosition(ctx: Context, commentId: string, container: HTMLDivElement): {
    left: number;
    top: number;
    width: number;
    height: number;
} | undefined;
export declare function onCommentBoxResizeStart(ctx: Context, globalCache: GlobalCache, e: MouseEvent, container: HTMLDivElement, { r, c, rc }: {
    r: number;
    c: number;
    rc: string;
...
export declare function onCommentBoxResizeEnd(ctx: Context, globalCache: GlobalCache, container: HTMLDivElement): void;
export declare function onCommentBoxMoveStart(ctx: Context, globalCache: GlobalCache, e: MouseEvent, container: HTMLDivElement, { r, c, rc }: {
    r: number;
    c: number;
    rc: string;
}, movingId: string): void;
export declare function onCommentBoxMove(ctx: Context, globalCache: GlobalCache, e: MouseEvent): boolean;
export declare function onCommentBoxMoveEnd(ctx: Context, globalCache: GlobalCache, container: HTMLDivElement): void;
export {};
