...
export declare function updateFormatCell(ctx: Context, d: CellMatrix, attr: keyof Cell, foucsStatus: any, row_st: number, row_ed: number, col_st: number, col_ed: number): void;
export declare function updateFormat(ctx: Context, $input: HTMLDivElement, d: CellMatrix, attr: keyof Cell, foucsStatus: any): void;
export declare function autoSelectionFormula(ctx: Context, cellInput: HTMLDivElement, formula: string, cache: GlobalCache): void;
...
export declare function handleBorder(ctx: Context, type: string): void;
...
export declare function handleTextSize(ctx: Context, cellInput: HTMLDivElement, size: number): void;
export declare function handleSum(ctx: Context, cellInput: HTMLDivElement, cache?: GlobalCache): void;
