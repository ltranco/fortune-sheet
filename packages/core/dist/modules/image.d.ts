...
export declare function onImageMoveStart(ctx: Context, globalCache: GlobalCache, e: MouseEvent, container: HTMLDivElement): void;
export declare function onImageMove(ctx: Context, globalCache: GlobalCache, e: MouseEvent): boolean;
export declare function onImageMoveEnd(ctx: Context, globalCache: GlobalCache, container: HTMLDivElement): void;
export declare function onImageResizeStart(ctx: Context, globalCache: GlobalCache, e: MouseEvent, container: HTMLDivElement, resizingSide: string): void;
export declare function onImageResize(ctx: Context, globalCache: GlobalCache, e: MouseEvent): boolean;
export declare function onImageResizeEnd(ctx: Context, globalCache: GlobalCache, container: HTMLDivElement): void;
export {};
