...
export declare function getFontSet(format: any, defaultFontSize: number): string;
...
export declare function getCellTextInfo(cell: Cell, renderCtx: CanvasRenderingContext2D, sheetCtx: Context, option: any): any;
