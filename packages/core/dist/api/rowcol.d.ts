...
export declare function setRowHeight(ctx: Context, rowInfo: Record<string, number>, options?: CommonOptions): void;
export declare function setColumnWidth(ctx: Context, columnInfo: Record<string, number>, options?: CommonOptions): void;
