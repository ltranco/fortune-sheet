import { defaultContext, defaultSettings, colLocation, handleColumnHeaderMouseDown, handleColSizeHandleMouseDown, handleContextMenu, selectTitlesMap, selectTitlesRange, colLocationByIndex, rowLocation, handleRowHeaderMouseDown, handleRowSizeHandleMouseDown, rowLocationByIndex, locale, getFlowdata, getStyleByCell, isInlineStringCell, getInlineStringHTML, getCellValue, createRangeHightlight, valueShowEs, escapeScriptTag, moveToEnd, cancelNormalSelected, moveHighlightCell, updateCell, handleFormulaInput, handleCellAreaMouseDown, handleCellAreaDoubleClick, selectAll, handleOverlayMouseMove, handleOverlayMouseUp, handleOverlayTouchStart, handleOverlayTouchMove, handleOverlayTouchEnd, showComments, drawArrow, getSelectionStyle, createDropCellRange, setEditingComment, onCommentBoxMoveStart, onCommentBoxResizeStart, onImageMoveStart, onImageResizeStart, updateContextWithSheetData, updateContextWithCanvas, initFreeze, Canvas, groupValuesRefresh, handleGlobalWheel, setCaretPosition, normalizedCellAttr, updateFormat, handleTextSize, handleHorizontalAlign, handleVerticalAlign, handleScreenShot, showImgChooser, insertImage, handleSum, autoSelectionFormula, handleMerge, handleBorder, handleFreeze, handleSort, toolbarItemSelectedFunc, toolbarItemClickHandler, handleTextColor, handleTextBackground, editComment, deleteComment, showHideComment, showHideAllComments, newComment, getRangetxt, getInlineStringNoStyle, rangeHightlightselected, editSheetName, addSheet, handleCopy, handlePasteByClick, insertRowCol, deleteRowCol, api, deleteSheet, opToPatch, patchToOp, filterPatch, inverseRowColOptions, ensureSheetIndex, initSheetIndex, getSheetIndex, handleGlobalKeyDown, handlePaste } from '@fortune-sheet/core';
import React, { useContext, useRef, useState, useCallback, useEffect, useMemo, useLayoutEffect, useImperativeHandle } from 'react';
...
var ColumnHeader = function ColumnHeader() {
  ...
  }), !context.luckysheet_cols_change_size && hoverLocation.col >= 0 && hoverLocation.col_pre >= 0 ? /*#__PURE__*/React.createElement("div", {
...
var RowHeader = function RowHeader() {
  ...
  }), hoverLocation.row >= 0 && hoverLocation.row_pre >= 0 ? /*#__PURE__*/React.createElement("div", {
...
var ContentEditable = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ContentEditable, [{
    ...
    value: function render() {
      ...
      }, _.omit(this.props, "innerRef", "onChange", "html", "onBlur", "autoFocus", "initialContent")), {}, {
        ref: function ref(e) {
          _this2.root = e;
...
var InputBox = function InputBox() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: firstSelection && !_.isEmpty(context.luckysheetCellUpdate) ? {
...
var SheetOverlay = function SheetOverlay() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement(ColumnHeader, null)), /*#__PURE__*/React.createElement("div", {
    ...
    style: ((_context$luckysheet_s = (_context$luckysheet_s2 = context.luckysheet_select_save) === null || _context$luckysheet_s2 === void 0 ? void 0 : _context$luckysheet_s2.length) !== null && _context$luckysheet_s !== void 0 ? _context$luckysheet_s : 0) > 0 ? {
      display: "block",
      left: (_$last = _.last(context.luckysheet_select_save)) === null || _$last === void 0 ? void 0 : _$last.left,
      width: (_$last2 = _.last(context.luckysheet_select_save)) === null || _$last2 === void 0 ? void 0 : _$last2.width,
      top: (_$last3 = _.last(context.luckysheet_select_save)) === null || _$last3 === void 0 ? void 0 : _$last3.top,
      height: (_$last4 = _.last(context.luckysheet_select_save)) === null || _$last4 === void 0 ? void 0 : _$last4.height
    } : {}
  ...
  }), /*#__PURE__*/React.createElement(InputBox, null), /*#__PURE__*/React.createElement("div", {
    id: "luckysheet-postil-showBoxs"
  }, _.concat((_context$commentBoxes2 = context.commentBoxes) === null || _context$commentBoxes2 === void 0 ? void 0 : _context$commentBoxes2.filter(function (v) {
  ...
  }, context.activeImg && /*#__PURE__*/React.createElement("div", {
    ...
    style: _objectSpread2(_objectSpread2({}, _.omit(context.activeImg, "src, left,top")), {}, {
...
var Toolbar = function Toolbar(_ref) {
  ...
  var getToolbarItem = useCallback(function (name, i) {
    ...
    if (["font-color", "background"].includes(name)) {
      ...
      return /*#__PURE__*/React.createElement("div", null, name === "font-color" && /*#__PURE__*/React.createElement("div", {
        style: {
          width: 17,
          height: 2,
    ...
    if (name === "format") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, defaultFmt.slice(0, defaultFmt.length - 2).map(function (_ref2, ii) {
          var text = _ref2.text,
              value = _ref2.value,
              example = _ref2.example;
          return value !== "split" ? /*#__PURE__*/React.createElement(Option, {
            key: value,
            onClick: function onClick() {
              setOpen(false);
              setContext(function (ctx) {
          ...
          }, example))) : /*#__PURE__*/React.createElement(MenuDivider, {
            key: ii
          });
        }));
      });
    ...
    if (name === "comment") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, itemData.map(function (_ref5) {
          var key = _ref5.key,
              text = _ref5.text,
    ...
    if (name === "quick-formula") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, _itemData.map(function (_ref6) {
    ...
    if (name === "merge-cell") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, itemdata.map(function (_ref7) {
          var text = _ref7.text,
              value = _ref7.value;
          return /*#__PURE__*/React.createElement(Option, {
            key: value,
    ...
    if (name === "border") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, _items2.map(function (_ref8, ii) {
          var text = _ref8.text,
              value = _ref8.value;
    ...
    if (name === "freeze") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, _items3.map(function (_ref9) {
          var text = _ref9.text,
              value = _ref9.value;
          return /*#__PURE__*/React.createElement(Option, {
            key: value,
    ...
    if (name === "sort") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, _items4.map(function (_ref10) {
    ...
    if (name === "text-wrap") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, _items5.map(function (_ref11) {
    ...
    if (name === "text-rotation") {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, _items6.map(function (_ref12) {
...
var SheetTab = function SheetTab() {
  ...
  }), /*#__PURE__*/React.createElement(SheetItem, {
  ...
  var getMenuElement = useCallback(function (name, i) {
    ...
    if (name === "insert-column") {
      return (selection === null || selection === void 0 ? void 0 : selection.row_select) ? null : ["left", "right"].map(function (dir) {
        ...
        }, /*#__PURE__*/React.createElement(React.Fragment, null, ((_context$lang = context.lang) === null || _context$lang === void 0 ? void 0 : _context$lang.startsWith("zh")) && /*#__PURE__*/React.createElement(React.Fragment, null, rightclick.to, /*#__PURE__*/React.createElement("span", {
        ...
        }, "".concat(rightclick.column, "  ")), !((_context$lang2 = context.lang) === null || _context$lang2 === void 0 ? void 0 : _context$lang2.startsWith("zh")) && /*#__PURE__*/React.createElement("span", {
          className: "luckysheet-cols-rows-shift-".concat(dir)
        }, rightclick[dir])));
      });
    }
    ...
    if (name === "insert-row") {
      return (selection === null || selection === void 0 ? void 0 : selection.column_select) ? null : ["top", "bottom"].map(function (dir) {
        ...
        return /*#__PURE__*/React.createElement(Menu, {
        ...
        }, /*#__PURE__*/React.createElement(React.Fragment, null, ((_context$lang3 = context.lang) === null || _context$lang3 === void 0 ? void 0 : _context$lang3.startsWith("zh")) && /*#__PURE__*/React.createElement(React.Fragment, null, rightclick.to, /*#__PURE__*/React.createElement("span", {
          className: "luckysheet-cols-rows-shift-".concat(dir)
        }, rightclick[dir])), "".concat(rightclick.insert, "  "), /*#__PURE__*/React.createElement("input", {
          onClick: function onClick(e) {
            return e.stopPropagation();
          ...
          className: "luckysheet-cols-rows-shift-word luckysheet-mousedown-cancel"
        }, "".concat(rightclick.row, "  ")), !((_context$lang4 = context.lang) === null || _context$lang4 === void 0 ? void 0 : _context$lang4.startsWith("zh")) && /*#__PURE__*/React.createElement("span", {
          className: "luckysheet-cols-rows-shift-".concat(dir)
        }, rightclick[dir])));
      });
    }
    ...
    if (name === "delete-column") {
      return (selection === null || selection === void 0 ? void 0 : selection.row_select) ? null : /*#__PURE__*/React.createElement(Menu, {
        key: "delete-col",
        onClick: function onClick() {
          if (!selection) return;
    ...
    if (name === "delete-row") {
      return (selection === null || selection === void 0 ? void 0 : selection.column_select) ? null : /*#__PURE__*/React.createElement(Menu, {
        key: "delete-row",
        onClick: function onClick() {
          if (!selection) return;
...
function generateAPIs(context, setContext, settings, cellInput, scrollbarX, scrollbarY) {
  return {
      ...
      setContext(function (ctx_) {
        ...
        if (specialOps.length > 0) {
          ...
          if (specialOp.op === "insertRowCol") {
            ctx_ = produce(ctx_, function (draftCtx) {
        ...
        var newContext = applyPatches(ctx_, patches);
        return newContext;
      }, {
        noHistory: true
      });
    ...
    setRowHeight: function setRowHeight(rowInfo) {
      ...
      return setContext(function (draftCtx) {
        return api.setRowHeight(draftCtx, rowInfo, options);
      });
    },
    setColumnWidth: function setColumnWidth(columnInfo) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return setContext(function (draftCtx) {
        return api.setColumnWidth(draftCtx, columnInfo, options);
      });
    },
    ...
    getSheet: function getSheet() {
      ...
      return api.getSheet(context, options);
    },
...
var Workbook = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var _useState = useState(defaultContext()),
      _useState2 = _slicedToArray(_useState, 2),
    ...
    setContextWithProduce(function (draftCtx) {
      ...
      if (_.isEmpty(data)) {
        ...
        if (lastRowNum && lastColNum) {
          var expandedData = _.times(lastRowNum + 1, function () {
            return _.times(lastColNum + 1, function () {
              return null;
            });
          });
  ...
  return /*#__PURE__*/React.createElement(WorkbookContext.Provider, {
    ...
    sheet: sheet
  }), mergedSettings.showSheetTabs && /*#__PURE__*/React.createElement(SheetTab, null), /*#__PURE__*/React.createElement(ContextMenu, null), /*#__PURE__*/React.createElement(SheetTabContextMenu, null), moreToolbarItems && /*#__PURE__*/React.createElement(MoreItemsContaier, {
